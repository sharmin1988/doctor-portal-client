...
const AddDoctor = () => {
    ...
    const { data: specialties, isLoading } = useQuery({
        queryKey: ['Specialty'],
        queryFn: async () => {
            const res = await fetch('https://doctors-portal-server-module-74.vercel.app/appointmentSpecialty')
        ...
        fetch(url, {
            ...
            .then(imgData => {
                if (imgData.success) {
                    ...
                    fetch('https://doctors-portal-server-module-74.vercel.app/doctors', {
                        method: 'POST',
                        headers: {
